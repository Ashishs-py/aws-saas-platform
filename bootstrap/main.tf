...
locals {
  state_bucket_name = "${var.org_prefix}-tfstate-${data.aws_caller_identity.current.account_id}-${var.state_region}"
...
resource "aws_iam_role" "github_deploy" {
  name                 = "${var.org_prefix}-github-deploy"
  description          = "Role assumed by GitHub Actions via OIDC. No static AWS keys are used."
